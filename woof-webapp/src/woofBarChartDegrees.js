...
function WoofBarChartDegrees({ data_name }) {
  ...
  return (
    <BarChart width={500} height={500} data={bias} margin={{ top: 5, right: 30, left: 20, bottom: 5 }} layout="vertical">
...
export default WoofBarChartDegrees;